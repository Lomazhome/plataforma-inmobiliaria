...
(function () {
  ...
  const PLANETS = [
    ...
    },
    {
      id: 'th',
      name: 'Threads',
      url: 'https://www.threads.com/@lomazhome',
      brand: '#000000',
      svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.36 11.21c-.09-.04-.18-.08-.27-.12-.16-2.95-1.77-4.64-4.46-4.66h-.04c-1.61 0-2.95.69-3.78 1.94l1.48 1.02c.62-.93 1.59-1.13 2.3-1.13h.03c.89.01 1.55.27 1.98.76.31.36.52.86.62 1.49a13.36 13.36 0 0 0-2.55-.12c-2.57.15-4.22 1.65-4.11 3.73.06 1.06.59 1.97 1.49 2.56.76.5 1.74.75 2.76.69 1.34-.07 2.39-.58 3.13-1.51.56-.7.91-1.62 1.07-2.77.65.39 1.13.91 1.4 1.53.45 1.06.48 2.79-.94 4.2-1.24 1.24-2.74 1.78-5 1.79-2.51-.02-4.4-.82-5.63-2.39-1.15-1.46-1.75-3.57-1.77-6.27.02-2.7.62-4.81 1.77-6.27 1.23-1.57 3.13-2.37 5.63-2.39 2.53.02 4.46.83 5.74 2.4.63.77 1.1 1.74 1.41 2.87l1.81-.48c-.38-1.39-.98-2.59-1.79-3.59C16.94 1.71 14.55.68 11.52.66h-.01C8.49.68 6.15 1.72 4.55 3.74c-1.41 1.79-2.14 4.28-2.16 7.4v.02c.02 3.12.75 5.61 2.16 7.4 1.6 2.02 3.94 3.06 6.96 3.08h.01c2.68-.02 4.57-.72 6.13-2.28 2.04-2.04 1.98-4.59 1.31-6.16-.47-1.13-1.37-2.05-2.6-2.66zm-4.68 3.78c-1.13.06-2.3-.45-2.35-1.5-.04-.78.55-1.65 2.42-1.76l.49-.01c.66 0 1.27.07 1.83.18-.19 2.51-1.37 3.04-2.39 3.09z"/></svg>'
    },
    {
      id: 'tt',
      name: 'TikTok',
      url: 'https://www.tiktok.com/@anglomaz',
      brand: '#FF0050',
      svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.83 20.1a6.34 6.34 0 0 0 10.86-4.43V8.66a8.16 8.16 0 0 0 4.77 1.52V6.73a4.85 4.85 0 0 1-1.87-.04z"/></svg>'
    },
    {
      id: 'yt',
      name: 'YouTube',
      url: 'https://www.youtube.com/@lomazhome',
      brand: '#FF0000',
      svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2C0 8.1 0 12 0 12s0 3.9.5 5.8a3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1C24 15.9 24 12 24 12s0-3.9-.5-5.8zM9.6 15.6V8.4l6.2 3.6-6.2 3.6z"/></svg>'
    },
    {
      id: 'gm',
      name: 'Gmail',
      url: 'mailto:Lomazhome@gmail.com',
      brand: '#EA4335',
      svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 5.5v13a1.5 1.5 0 0 1-1.5 1.5H18V8.2l-6 4.5-6-4.5V20H3.5A1.5 1.5 0 0 1 2 18.5v-13A1.5 1.5 0 0 1 3.5 4h.5l8 6 8-6h.5A1.5 1.5 0 0 1 22 5.5z"/></svg>'
    }
  ];
